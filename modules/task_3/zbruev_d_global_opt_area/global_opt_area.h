...
#ifndef MODULES_TASK_3_ZBRUEV_DENIS_GLOBAL_OPT_AREA_H_
#define MODULES_TASK_3_ZBRUEV_DENIS_GLOBAL_OPT_AREA_H_
#include <functional>
#include <vector>
#include <string>
...
#endif  // MODULES_TASK_3_ZBRUEV_DENIS_GLOBAL_OPT_AREA_H_
