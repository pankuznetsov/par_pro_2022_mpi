...
#ifndef MODULES_TASK_2_SILAEVA_A_GAUSSIAN_ELIMINATION_VERTICAL_GAUSSIAN_ELIMINATION_H_
#define MODULES_TASK_2_SILAEVA_A_GAUSSIAN_ELIMINATION_VERTICAL_GAUSSIAN_ELIMINATION_H_
#include <vector>
